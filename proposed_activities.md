...
jlarson: foundational  This should be the first step of an ongoing project to built next generation voice platform.  Follow the approach of the W3C community by building the overall architecture and identifying the interfaces between components
...
jlarson: exploritoy, but we should consider another working grooup/committee to investigate
...
jlarson: foundational, in development process
